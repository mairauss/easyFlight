...
<title>easyFLight:Cancel Flight</title>
...
<body>
   ...
   <ul>
		...
		<li><a class="active" href="CancelFlight.jsp">Cancel Flight</a></li>
...
<form method="GET" action="CancelFlight" class="grid_6">
<br></br>
<center> <% Fluggesellschaft currentFG = null;
	 			currentFG = (Fluggesellschaft)((session.getAttribute("currentSessionFG")));%> 
	 			<br></br><h2>Hier können Sie einen Flug loeschen, <%= currentFG.getName() %> </h2>
	 </center>
	<br></br>
<br></br><br></br>
