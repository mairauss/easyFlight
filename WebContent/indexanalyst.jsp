...
<body>
	...
	<br></br>
	<br></br>
	 <center> <% Analyst currentA = null;
	 			currentA = (Analyst)((session.getAttribute("currentSessionAnalyst")));%> 
	 			<br></br><h2>Wilkommen auf der Seite für Analysten, <%= currentA.getVorname() %> </h2>
	 </center>
